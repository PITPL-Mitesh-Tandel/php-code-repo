...
(function() {
    ...
    controller('MainController', ['$scope','$rootScope', '$state', '$timeout', '$http', 'studiosResolverFactory','$location','$stateParams', function($scope, $rootScope, $state, $timeout, $http, studios,$location,$stateParams) {
        $scope.studios = null;
...
(function () {
  ...
  var homeResolverFactory = function ($http,$stateParams, Hero, News, Studio, Think, Work, Career, Grid, Twitter) 
  {
...
(function () {
  ...
  function WorkController($scope, work,$stateParams) {
    $scope.$on('animate.ready', function () {
      $scope.$emit('animate.init');
    ...
    $scope.$on('animate.ready', function () {
     ...
     // $scope.setBreadcrumbs([{ 'title': 'WORK', 'ref': 'pages-work-category', 'color': 'work' }]);
        //$scope.setBreadcrumbs([{ 'title': 'WORK', 'ref': 'pages-work-category', 'color': 'work' }, { 'title': $stateParams.id, 'color': '','display_menu':'1' }]);
          $scope.setBreadcrumbs([{ 'title': 'WORK', 'ref': 'pages-work-category', 'color': 'work' }, { 'title': "Categories", 'color': '','display_menu':'1' }]);
    ...
    $scope.$on('animate.ready', function () {
      ...
      work.get($stateParams.id)
        .then(function (data) { 
          ...
          $scope.setBreadcrumbs([{ 'title': 'WORK', 'ref': 'pages-work-index', 'color': 'work' }, { 'title': 'Categories', 'ref': 'pages-work-index', 'color': 'work','display_menu':'1' }, { 'title': $scope.work.title, 'color': '' }]);
              $scope.setHeaderDisplay(false); 
              console.log($scope.headerDisplay);
