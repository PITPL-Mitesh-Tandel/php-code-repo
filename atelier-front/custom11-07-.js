...
(function () {
 ...
 // var url="http://www.appdemo.co.in/atelier/content/0.1/get-index?lang=en";
...
(function () {
 ...
 //.
      ...
      $scope.setBreadcrumbs([{ 'title': 'CONTACT', 'ref': 'pages-contact', 'color': 'contact' }]);
        ...
        {
           $scope.setPagedescription("Nous opérons à partir de notre unique atelier à Paris / France. Appelez-nous, envoyez-nous un courriel ou passez nous voir pour discuter.");
