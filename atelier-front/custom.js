  ...
  service("modelFactory", function () {
          ...
          if (this.data.hasOwnProperty(i) === true) {
            throw new Error(
              "Unable to set properties of `" +
                i +
                "`. Property name conflicts with an existing method or value in Object."
            );
          }
    ...
    Model.prototype.getTags = function () {
      if (this.data && this.data._tags) {
        ...
        if (
          typeof this.data._tags === "object" &&
          typeof this.data._tags.length === "number"
        ) {
    ...
    Collection.prototype.templatize = function (patterns, templateDirectory) {
      ...
      var newContainer = function () {
        ...
        return {
          ...
          template:
            patterns[currentPattern].value +
            "-" +
            patterns[currentPattern].variation,
      ...
      var templated = this._data.reduce(function (prev, current) {
        ...
        if (
          prev[prev.length - 1].data.length == patterns[currentPattern].value
        ) {
          currentPattern++;
      ...
      if (
        lastTemplateData.length < templated[templated.length - 1].availableSlots
      ) {
        var newTemplate = patterns.find(function (item) {
          return lastTemplateData.length == item.value;
        });

        templated[templated.length - 1].template =
          newTemplate.value + "-" + newTemplate.variation;
...
(function () {
  ...
  var factory = angular.module("models.custom.news", [
    "models.model",
    "slugifier",
  ]).factory;
  ...
  factory("newsFactory", [
    ...
    "modelFactory",
    "Slug",
    function ($state, $stateParams, $window, modelFactory, Slug) {
      function News() {}
      ...
      News.prototype.go = function () {
        if (this["link"] != "") {
          ...
          $state.go("pages-news-show", {
            article: this["title-slug"],
      ...
      Object.defineProperty(News.prototype, "title-slug", {
        get: function () {
          return Slug.slugify(
            typeof this.linkResource === "string"
              ? this.linkResource
              : this.title
          );
        },
...
(function () {
  ...
  var factory = angular.module("models.custom.publications", [
    "models.model",
    "slugifier",
  ]).factory;

  factory("publicationsFactory", [
    "$state",
    "$stateParams",
    "modelFactory",
    "Slug",
    function ($state, $stateParams, modelFactory, Slug) {
      function Publications() {}

      Publications.prototype = Object.create(modelFactory.prototype);

      Publications.prototype.go = function () {
        $state.go("pages-publications-show", {
          article: this["title-slug"],
          lang: $stateParams.lang,
        });
      };
...
(function () {
  ...
  var factory = angular.module("models.custom.studio", [
    "models.model",
    "slugifier",
  ]).factory;
  ...
  factory("studioFactory", [
    ...
    "inflector",
    "Slug",
    function ($state, modelFactory, inflector, Slug) {
      function Studio() {}
      ...
      Object.defineProperty(Studio.prototype, "location-slug", {
        get: function () {
          return Slug.slugify(
            typeof this.location === "string" ? this.location : this.title
          );
        },
      });
...
(function () {
  ...
  var factory = angular.module("models.custom.think", [
    "models.model",
    "slugifier",
  ]).factory;
  ...
  factory("thinkFactory", [
    ...
    "modelFactory",
    "Slug",
    function ($state, modelFactory, Slug) {
      function Think() {
...
(function () {
  ...
  var factory = angular.module("models.custom.work", [
    "models.model",
    "slugifier",
  ]).factory;
  ...
  factory("workFactory", [
    ...
    function ($state, modelFactory, Slug, $stateParams) {
      ...
      Work.getTitle = function () {
        return typeof this.data._title === "undefined"
          ? this.data._client
          : this.data._title;
      };
...
(function () {
  ...
  var factory = angular.module("models.custom.career", [
    "models.model",
  ]).factory;

  factory("careerFactory", [
    "$state",
    "modelFactory",
    function ($state, modelFactory) {
      function Career() {}
...
angular.module("models.custom.grid", ["models.model"]).factory("gridFactory", [
  "$state",
  "modelFactory",
  function ($state, modelFactory) {
    "use strict";
...
(function () {
  ...
  var factory = angular.module("models.custom.twitter", [
    "models.model",
    "cergis.services.ify",
  ]).factory;
  ...
  factory("twitterFactory", [
    ...
    "modelFactory",
    "ify",
    function ($state, modelFactory, ify) {
      function Twitter() {}
...
(function () {
  ...
  var factory = angular.module("models.custom.instagram", [
    "models.model",
  ]).factory;
...
(function () {
  ...
  angular
    .module("models.custom.search", ["models.model"])
  ...
  function SearchFactory($state, $stateParams, $rootScope, modelFactory) {
    function Search() {}
...
(function () {
  ...
  var factory = angular.module("models.collection.work", [
    "models.collection",
  ]).factory;

  factory("workCollectionFactory", [
    "$state",
    "collectionFactory",
    function ($state, collectionFactory) {
      ...
      WorkCollection.prototype.templatize = function () {
        var patterns = [{ value: 1, variation: "container" }];

        return parentTemplatizer.call(
          this,
          patterns,
          "pages/work/content-templates/"
        );
      };
      ...
      WorkCollection.prototype.paginate = function (items, reverse) {
        ...
        for (var i = 0; i < paginated.length; i++) {
          ...
          var templateName = reverse
            ? paginated[i].length + "-container-reverse"
            : paginated[i].length + "-container";
...
(function () {
  ...
  var factory = angular.module("models.collection.studio", [
    "models.collection",
  ]).factory;

  factory("studioCollectionFactory", [
    "$state",
    "collectionFactory",
    function ($state, collectionFactory) {
...
(function () {
  ...
  var factory = angular.module("models.collection.think", [
    "models.collection",
  ]).factory;

  factory("thinkCollectionFactory", [
    "$state",
    "collectionFactory",
    function ($state, collectionFactory) {
  ...
  module.directive("relatedLinks", [
    ...
    function (think) {
      return {
        ...
        templateUrl:
          "assets/frontend/js/modules/components/related-links/related-links.html",
        link: function (scope) {
          think.getAll().then(function (data) {
            var formatted = _.chain(data.all()).shuffle().chunk(2).value();
  ...
  controller("MainController", [
    ...
    function (
      ...
      /*
        ...
        var part_url = $location.path().split('/');
      
      
        console.log(part_url[1]); 
            console.log(part_url[0]); 
        
     
        if(part_url[0]=='fr')
        {
            $rootScope.eng_url  =  $location.absUrl().replace('/en', '/fr');
          $rootScope.eng_url  =   $rootScope.eng_url.replace('/category/urban', '/category/urbain');
          $rootScope.eng_url  =   $rootScope.eng_url.replace('/category/commercial', '/category/commerciale');
          $rootScope.eng_url  =   $rootScope.eng_url.replace('/category/institution', '/category/institutionnel');
          $rootScope.eng_url  =   $rootScope.eng_url.replace('/category/hospitality', '/category/hôtelier');
          $rootScope.eng_url  =   $rootScope.eng_url.replace('/category/event', '/category/evènementiel');
          $rootScope.eng_url  =   $rootScope.eng_url.replace('/category/product', '/category/produit');
           
           $rootScope.french_url = $location.absUrl();   //no change in french url
        }
          else
          {
            $rootScope.french_url  =  $location.absUrl().replace('/en', '/fr');
            $rootScope.french_url  =   $rootScope.french_url.replace('/category/urban', '/category/urbain');
            $rootScope.french_url  =   $rootScope.french_url.replace('/category/commercial', '/category/commerciale');
            $rootScope.french_url  =   $rootScope.french_url.replace('/category/institution', '/category/institutionnel');
            $rootScope.french_url  =   $rootScope.french_url.replace('/category/hospitality', '/category/hôtelier');
            $rootScope.french_url  =   $rootScope.french_url.replace('/category/event', '/category/evènementiel');
            $rootScope.french_url  =   $rootScope.french_url.replace('/category/product', '/category/produit');
          
            $rootScope.eng_url = $location.absUrl();   //no change in eng url
          }
*/
      ...
      ///   console.log( $window.document.getElementsByName('description')[0].content);
      $scope.setPagedescription = function (value) {
        $window.document.getElementsByName("description")[0].content = value;
        console.log(
      ...
      $scope.toggleSearch = function () {
        ...
        if ($rootScope.magToggle) {
          ...
          searchStateParams =
            $state.current.name === "search-results"
          ...
          $scope.links = [
            {
              ...
              title: "Work",
              background: $scope.colors.work,
              color: $scope.colors2.work,
            },
            ...
            //{state: 'pages-career-index', 'title': 'Careers', background: $scope.colors.career},
            {
              ...
              title: "About",
              background: $scope.colors.career,
              color: $scope.colors2.career,
            },
            {
              state: "pages-news",
              title: "News",
              background: $scope.colors.news,
              color: $scope.colors2.news,
            },
            {
              state: "pages-publications",
              title: "Media",
              background: $scope.colors.studios,
              color: $scope.colors2.studios,
            },

            {
              state: "pages-contact",
              title: "Contact",
              background: $scope.colors.contact,
              color: $scope.colors2.contact,
            },
          ];
...
(function () {
  ...
  var homeResolverFactory = function (
    $http,
    $rootScope,
    $stateParams,
    Hero,
    ...
    var createNewModelObjectOfType = function (data) {
      ...
      switch (data.type) {
        ...
        default:
          throw new Error(
            "Missing handler for data of type `" + data.type + "`"
          );
      }
    ...
    return {
      getAll: function (tweet) {
        //    var url="https://www.atelierdada.com/atelier/content/0.1/get-index?lang=en";
        var url =
          "https://www.atelierdada.com/atelier/content/0.1/get-index?lang=en";

        //console.log('home factory '+ $rootScope.lang2);

        if ($rootScope.lang2 == "fr") {
          //url = "backend/api/index-fr.json";
          var url =
            "https://www.atelierdada.com/atelier/content/0.1/get-index?lang=fr";
          //   var url="http://www.appdemo.co.in/atelier/content/0.1/get-index?lang=fr";
        }
...
(function () {
  ...
  angular.module("dada.home").controller("HomeController", [
    ...
    function ($scope, $timeout, home, $stateParams, $http) {
      $timeout(function () {
      ...
      home
        ...
        .then(function (data) {
          ...
          $http
            .get(
              "https://www.atelierdada.com/atelier/content/0.1/get-testimonials?lang=" +
                $stateParams.lang
            )
        ...
        "Ernst Handel",
              ...
              //        $scope.testimonials[0]['testimonial'] = "this is test";
              //        $scope.testimonials[1]['testimonial'] = "this is test two";

              //   $scope.testimonials[0] = "this is test";
              //   $scope.testimonials[1] = "this is another test";
          ...
          $scope.setPagedescription(
            'We create imaginative lighting design solutions for architecture, landscape and urbanism, where space becomes "made of light"! "Out-of the Box and state of the Art lighting design solutions for the inclusive and sustainable city of tomorrow"'
          );
          $scope.setPagetitle("Smart lighting design");
          if ($stateParams.lang == "fr") {
            $scope.setPagedescription(
              'Nous créons des solutions d’éclairage imaginatives pour l’architecture, le paysage et l’urbanisme, pour que l’espace soit « fait de lumière » ! "Des solutions d\'éclairage novatrices et de pointe pour la ville inclusive et durable de demain"'
            );
            $scope.setPagetitle("L'éclairage innovant, pour vous");
          }
      ...
      return {
        ...
        link: function (scope) {
          ...
          scope.getTemplateUrl = function () {
            ...
            return (
              "assets/frontend/partials/pages/home/directives/" +
              template +
              ".html"
            );
          };
...
(function () {
  ...
  workResolverFactory.$inject = [
    "$http",
    "$state",
    "$stateParams",
    "contentFormatter",
    "workFactory",
    "workCollectionFactory",
  ];
  function workResolverFactory(
    $http,
    $state,
    $stateParams,
    contentFormatter,
    ...
    factoryObj.getAll = function () {
      return $http({
        ...
        cache: true,
        url:
          "https://www.atelierdada.com/atelier/content/0.1/get-work?lang=" +
          $stateParams.lang,
    ...
    factoryObj.getAllNotHidden = function () {
      return $http({
        ...
        cache: true,
        url:
          "https://www.atelierdada.com/atelier/content/0.1/get-work?featured=1&lang=" +
          $stateParams.lang,
      }).then(function (result) {
        var formatted = {};
    ...
    factoryObj.getworkcategory = function ($id) {
      return $http({
        ...
        cache: true,
        url:
          "https://www.atelierdada.com/atelier/content/0.1/get-work?tag=" +
          $id +
          "&lang=" +
          $stateParams.lang,
      }).then(function (result) {
    ...
    factoryObj.getAllByStudio = function (studio) {
      return factoryObj.getAll().then(function (formatted) {
        ...
        var result = formatted.data.all().reduce(function (prev, current) {
          var displayWork = current["search-studios"]
            .split(",")
            .find(function (workStudio) {
        ...
        for (var i = 0; i < formatted.data.all().length; i++) {
          if (slug === formatted.data.all()[i]["title-slug"]) {
            ...
            for (var j = 0; j < data.content.length; j++) {
              console.log(data.content[j].data.Video);
              if (typeof data.content[j].data.Video !== "undefined")
                ...
                data.content[j].data.Video =
                  data.content[j].data.Video +
                  "?title=0&amp;byline=0&amp;portrait=0&amp;badge=0";
              data.content[j].data.originalurl =
                data.content[j].data.Video +
                "?title=0&amp;byline=0&amp;portrait=0&amp;badge=0";
            }
            break;
...
(function () {
  ...
  function WorkController($scope, work, $stateParams, $window, $document) {
    $scope.$on("animate.ready", function () {
      ...
      if ($stateParams.lang == "en") {
        $scope.setBreadcrumbs([
          { title: "WORK", ref: "pages-work-index", color: "work" },
          {
            title: "Categories",
            ref: "pages-work-index",
            color: "work",
            display_menu: "1",
          },
        ]);
        ...
        $scope.setBreadcrumbs([
          { title: "Projets", ref: "pages-work-index", color: "work" },
          {
            title: "Typologie",
            ref: "pages-work-index",
            color: "work",
      ...
      if ($stateParams.lang == "en") {
        $scope.setPagetitle("Featured work");
        $scope.setPagedescription(
          "Our projects featured here give a flavor of the best, newest and most innovative lighting design work."
        );
      } else {
        $scope.setPagetitle("Zoom projets");
        $scope.setPagedescription(
          "Noss projets présentés ici donnent un aperçu du meilleur, du plus récent et du plus innovant travail de conception lumière."
        );
      }

      work.getAllNotHidden().then(function (data) {
  ...
  function WorkCategoryController($scope, work, $stateParams) {
    ...
    $scope.$on("animate.ready", function () {
      ...
      if ($stateParams.lang == "en") {
        $scope.setBreadcrumbs([
          { title: "WORK", ref: "pages-work-index", color: "work" },
          { title: "Categories", color: "", display_menu: "1" },
        ]);
      } else {
        ...
        $scope.setBreadcrumbs([
          { title: "Lumières", ref: "pages-work-index", color: "work" },
          { title: "Typologie", color: "", display_menu: "1" },
        ]);
      }
      ...
      work.getworkcategory($stateParams.id).then(
        function (data) {
          $scope.workGrid = data.data.templatize();
          $scope.workResponsive = data.data.paginate(1);
          $scope.overview = data.overview;
    ...
    $scope.$on("animate.ready", function () {
      ...
      work
        ...
        .then(function (data) {
          ...
          //  if($stateParams.id=="the-mango-tree-house-facade")
          if ($scope.work["night-cover"] != "") {
            //console.log($scope.work['night-cover']);

            //  $scope.member1 = "http://www.appdemo.co.in/atelier/file-manager/content/4063033833478374_1485159434_203665.jpg";
            $scope.member1 =
              "https://www.atelierdada.com/atelier/file-manager/content/" +
              $scope.work["night-cover"];
          } else {
            $scope.member1 = $scope.work.background;
          }

          $scope.imgsrc = "images/marie-about.jpg";

          //  $scope.member1 = "false";
          // $scope.member1 = "http://www.appdemo.co.in/atelier/file-manager/content/4063033833478374_1485159434_203665.jpg";
          $scope.ori_team_image1 = "images/marie-about.jpg";

          if (
            $stateParams.lang == "en" &&
            $state.current.name == "pages-work-show"
          ) {
            $scope.setSubCat(data["work-tags"]);
            $scope.setBreadcrumbs([
              {
                title: "WORK",
                ref: "pages-work-index({lang:'en'})",
                color: "work",
              },
              {
                title: "Categories",
          ...
          if ($scope.work["meta-title"] != "") {
            $scope.setPagetitle($scope.work["meta-title"]);
          } else {
            $scope.setPagetitle(
              $scope.work.title + " | " + $scope.work.location
            );
          }

          if ($scope.work["meta-description"] != "") {
            $scope.setPagedescription($scope.work["meta-description"]);
          }
        ...
        .then(function () {
          return work.getAll().then(function (formatted) {
            ...
            while (results.length < 2) {
              ...
              if (
                selection["title-slug"] !== $stateParams.id &&
        ...
        .then(function (data) {
          $http
            .get(
              "https://www.atelierdada.com/atelier/content/0.1/get-related-work?slug=" +
                $stateParams.id +
                "&lang=" +
                $stateParams.lang
            )
            .then(function (response) {
              ...
              $scope.related.data = response.data;
  ...
  module.config([
    ...
    function ($stateProvider) {
      $stateProvider
        ...
        .state("pages-about-show", {
          url: "/:lang/about/:id",
          templateUrl: "assets/frontend/partials/pages/about-member.html",
...
(function () {
  ...
  module.controller("AboutshowController", [
    "$scope",
    "$http",
    "$timeout",
    "$stateParams",
    "aboutResolverFactory",
    "preloaderService",
    function ($scope, $http, $timeout, $stateParams, about, PreloaderService) {
      $scope.$on("animate.ready", function () {
        $scope.$emit("animate.init");

        var title = $stateParams.id.replace(/-/g, " ");
        ...
        if ($stateParams.lang == "en") {
          ...
          $scope.setBreadcrumbs([
            { title: "ABOUT", ref: "pages-about-index({lang:'en'})" },
            { title: title, color: "" },
          ]);
        } else {
          // $scope.setBreadcrumbs([{ 'title': 'ATELIER' }]);
          $scope.setBreadcrumbs([
            { title: "ATELIER", ref: "pages-about-index({lang:'fr'})" },
            { title: title, color: "" },
          ]);
        }
        ...
        if ($stateParams.id == "nirmit-jhaveri") {
          //$scope.imgsrc = "images/nirmit-about.jpg";

          $scope.linkedin_link =
            "https://www.linkedin.com/in/nirmit-jhaveri-8a95423?ppe=1";
          if ($stateParams.lang == "en") {
            //var url = "backend/api/about-nirmit.json";
            var url =
              "https://www.atelierdada.com/atelier/content/0.1/get-page?slug=about-nirmit&lang=en";

            $scope.setPagetitle(
              "Nirmit Jhaveri | Lighting design Principal of Atelier dada"
            );
            $scope.setPagedescription(
              "Nirmit comes with strong professional background in architecture, urban design and interior design prior to specializing in lighting design."
            );
          } else {
            // var url = "backend/api/about-nirmit-fr.json";

            var url =
              "https://www.atelierdada.com/atelier/content/0.1/get-page?slug=about-nirmit&lang=fr";
            $scope.setPagetitle(
              "Nirmit Jhaveri | Concepteur lumière Principale de l'Atelier dada"
            );
            $scope.setPagedescription(
              "Concepteur lumière Principale de l'Atelier dada"
            );
          }
        }
        ...
        // console.log($stateParams.id);
        if (
          $stateParams.id == "marie-ikram-bouhlel-jhaveri" ||
          $stateParams.id == "marie-ikram-bouhlel"
        ) {
          console.log("Marie page");

          $scope.imgsrc = "images/marie-about.jpg";
          // var url  = "http://www.appdemo.co.in/atelier/content/0.1/get-page?slug=about-marie&lang=en";

          //  var url = "backend/api/about-marie.json";
          $scope.linkedin_link = "https://in.linkedin.com/in/marieikrambouhlel";
          $scope.ace_link =
            "http://www.ace-fr.org/membres/concepteur/actif-senior/bouhlel-marie-ikram/";
          $scope.viado_link = "http://fr.viadeo.com/fr/profile/ikram.bouhlel";
          // $scope.iald_link =
          //   "https://www.iald.org/Designer-Directory/Designers/Marie-Ikram-Bouhlel";

            $scope.iald_link =
            "https://www.iald.org/IALD/Contacts/PublicProfile.aspx?ID=101006";

          console.log($scope.linkedin_link);

          if ($stateParams.lang == "en") {
            var url =
              "https://www.atelierdada.com/atelier/content/0.1/get-page?slug=about-marie&lang=en";
            //   var url = "backend/api/about-marie.json";
            $scope.setPagetitle(
              "Marie Ikram Bouhlel | Founder and design principal"
            );
            $scope.setPagedescription(
              "Founder and lighting design principal of Atelier dada"
            );
          } else {
            var url =
              "https://www.atelierdada.com/atelier/content/0.1/get-page?slug=about-marie&lang=fr";
            //var url = "backend/api/about-marie-fr.json";
            $scope.setPagetitle(
              "Marie Ikram Bouhlel | fondatrice et dirigente de l'atelier dada"
            );
            $scope.setPagedescription(
              "Fondatrice et dirigente de l'atelier dada"
            );
          }
        }
        $http({ method: "GET", cache: true, url: url }).then(function (
          response
        ) {
          $scope.about = response.data;
          $scope.imgsrc = response.data.content[1].data["OneColumnImage"];
  ...
  module.controller("AboutController", [
    ...
    "aboutResolverFactory",
    "preloaderService",
    function ($scope, $timeout, $stateParams, about, PreloaderService) {
      $scope.$on("animate.ready", function () {
        $scope.$emit("animate.init");
        ...
        if ($stateParams.lang == "en") {
          $scope.setPagedescription(
            "To understand more about our expertise and design approach, please don't hesitate to contact us for a chat."
          );
          $scope.setPagetitle(
            "Multi-award winning Innovative lighting design professionals"
          );

          $scope.member1 = "images/contact-us/yagnesh.jpg";
          $scope.member2 = "images/contact-us/neha.jpg";
          $scope.member3 = "images/contact-us/nirmit.jpg";
          $scope.member4 = "images/contact-us/marie.jpg";
          $scope.member5 = "images/contact-us/prem.jpg";
          $scope.member6 = "images/contact-us/nath.jpg";
          $scope.member7 = "images/contact-us/sundar.jpg";
        } else {
          $scope.setPagetitle(
            "Professionnels de l'éclairage novateurs et primés"
          );
          $scope.setPagedescription(
            "Pour en savoir plus sur notre expertise et approche conceptuelle, n'hésitez pas à nous contacter pour en discuter."
          );
          /*

              $scope.member1 = "images/contact-us/yagnesh-fr.jpg";
              $scope.member2 = "images/contact-us/neha-fr.jpg";
              $scope.member3 = "images/contact-us/nirmit-fr.jpg";
              $scope.member4 = "images/contact-us/marie-fr.jpg";
              $scope.member5 = "images/contact-us/prem-fr.jpg";
              $scope.member6 = "images/contact-us/nath-fr.jpg";
              $scope.member7 = "images/contact-us/sundar-fr.jpg";  */
        }

        about.getContent().then(function (response) {
          $scope.about = response;

          $scope.imgsrc = response.content[3]["data"]["OneColumnImage"];
          $scope.ori_team_image = response.content[3]["data"]["OneColumnImage"];

          /*
              $scope.member1 =  response.content[4]['data']['OneColumnImage'];
              $scope.member2 =  response.content[5]['data']['OneColumnImage'];
              $scope.member3 =  response.content[6]['data']['OneColumnImage'];
              $scope.member4 = response.content[7]['data']['OneColumnImage'];
              $scope.member5 = response.content[8]['data']['OneColumnImage'];
            
              $scope.member7 = response.content[9]['data']['OneColumnImage'];

              */

          $scope.member1 = response.content[3]["data"]["OneColumnImage"];
          $scope.member2 = response.content[3]["data"]["OneColumnImage"];
          $scope.member3 = response.content[3]["data"]["OneColumnImage"];
          $scope.member4 = response.content[3]["data"]["OneColumnImage"];
          $scope.member5 = response.content[3]["data"]["OneColumnImage"];

          $scope.member7 = response.content[3]["data"]["OneColumnImage"];

          // console.log("img"+$scope.imgsrc);

          //  $scope.default_img = response.background;

          //console.log("default team image " +  $scope.default_img );

          $scope.member1 = response.content[3]["data"]["OneColumnImage"]; //. "images/contact-us/yagnesh.jpg";
          //    console.log($scope.member1);
          $scope.$emit("animate.enter", true);
        });
      });
    },
...
(function () {
  ...
  module.factory("aboutResolverFactory", [
    "$http",
    "$state",
    "$stateParams",
    "contentFormatter",
    "aboutFactory",
    function ($http, $state, $stateParams, contentFormatter, About) {
      var factoryObj = {};
      ...
      factoryObj.getContent = function () {
        ...
        var url =
          "https://www.atelierdada.com/atelier/content/0.1/get-page?slug=about-us&lang=en";

        if ($stateParams.lang == "fr") {
          //   url = "backend/api/about-us-fr.json";
          url =
            "https://www.atelierdada.com/atelier/content/0.1/get-page?slug=about-us&lang=fr";
        }

        return $http({ method: "GET", cache: true, url: url }).then(function (
          response
        ) {
          var data = response.data;
          data.permalink = $state.href($state.current.name, $state.params, {
            absolute: true,
          });
          return data;
        });
    ...
    function ($state, $stateParams, $scope, news) {
      ...
      $scope.$on("animate.ready", function () {
        ...
        if ($stateParams.lang == "en") {
          ...
          $scope.setBreadcrumbs([
            { title: "ACTUALITÉS", ref: "pages-news", color: "news" },
          ]);
        }

        $scope.language = $stateParams.lang;
        if ($stateParams.lang == "en") {
          $scope.setPagetitle("Latest News");
          $scope.setPagedescription(
            "The latest news and press coverage about Atelier dada."
          );
        } else {
          $scope.setPagetitle("Dernières Nouvelles");
          $scope.setPagedescription(
            "Les dernières actualités et publications sur l'Atelier dada."
          );
        }
    ...
    function ($scope, $state, $stateParams, news) {
      ...
      $scope.$on("animate.ready", function () {
        ...
        var onLoad = function (data) {
          ...
          if (
            $stateParams.lang == "en" &&
            $state.current.name == "pages-news-show"
          ) {
            $scope.setBreadcrumbs([
...
(function () {
  ...
  module.factory("newsResolverFactory", [
    "$http",
    "$stateParams",
    "newsFactory",
    function ($http, $stateParams, News) {
      ...
      return {
        getAll: function () {
          return $http({
            ...
            cache: true,
            url:
              "https://www.atelierdada.com/atelier/content/0.1/get-contents?type=n&lang=" +
              $stateParams.lang,
          }).then(function (result) {
  ...
  module.controller("PublicationsController", [
    ...
    function ($scope, $stateParams, publications) {
      ...
      $scope.$on("animate.ready", function () {
        ...
        if ($stateParams.lang == "en") {
          $scope.setBreadcrumbs([
            { title: "MEDIA", ref: "pages-publications", color: "studios" },
          ]);
        } else {
          $scope.setBreadcrumbs([
            { title: "MÉDIA", ref: "pages-publications", color: "studios" },
          ]);
        }

        $scope.language = $stateParams.lang;
        if ($stateParams.lang == "en") {
          $scope.setPagetitle("International Awards | Media | Press");
          $scope.setPagedescription(
            "Read more about awards we won across the globe and recent publications."
          );
        } else {
          $scope.setPagetitle("Prix Internationaux | Média |  Presse ");
          $scope.setPagedescription(
            "En savoir plus sur les publications récentes et les prix que nous avons remportés à travers le monde."
          );
        }
        var onLoad = function (data) {
    ...
    function ($scope, $state, $stateParams, publications) {
      ...
      $scope.$on("animate.ready", function () {
        ...
        var onLoad = function (data) {
          ...
          if (
            $stateParams.lang == "en" &&
            $state.current.name == "pages-publications-show"
          ) {
            $scope.setBreadcrumbs([
              {
                title: "MEDIA",
                ref: "pages-publications({lang:'en'})",
                color: "studios",
              },
            ...
            $scope.setBreadcrumbs([
              {
                title: "MÉDIA",
                ref: "pages-publications({lang:'fr'})",
                color: "studios",
              },
              { title: controller.publications.title },
            ]);
...
(function () {
  ...
  module.factory("publicationsResolverFactory", [
    "$http",
    "$stateParams",
    "publicationsFactory",
    function ($http, $stateParams, Publications) {
      function format(item) {
      ...
      return {
        getAll: function () {
          return $http({
            ...
            cache: true,
            url:
              "https://www.atelierdada.com/atelier/content/0.1/get-contents?type=c&lang=" +
              $stateParams.lang,
          }).then(function (result) {
            var promoted = result.data.filter(function (item) {
              return item.promoted == true;
  ...
  function ThinkFactory($http, $state, Think, ThinkCollection) {
    ...
    var get = function (slug) {
      return getAll().then(function (formatted) {
        var selection = formatted.all().find(function (x) {
  ...
  module.controller("ThinkController", [
    ...
    function ($scope, think) {
      ...
      $scope.$on("animate.ready", function () {
        ...
        $scope.setBreadcrumbs([
          { title: "THINK", ref: "pages-think-index", color: "think" },
        ]);
        $scope.setHeaderDisplay(false);
        ...
        think.getAll().then(function (response) {
          controller.think = response.templatize();
...
(function () {
  ...
  studiosResolverFactory.$inject = [
    "$http",
    "$stateParams",
    "studioFactory",
    "studioCollectionFactory",
  ];

  function studiosResolverFactory(
    $http,
    $stateParams,
    Studio,
    StudioCollection
    ...
    var getAll = function () {
      if ($stateParams.lang == "en") {
        var url = "backend/api/studios.json";
      } else {
        var url = "backend/api/studios-fr.json";
      }
    ...
    var getInstagramPosts = function (studio) {
      return $http.jsonp(
        "backend/social/instagram/" + studio + "?callback=JSON_CALLBACK"
      );
    };
...
(function () {
  ...
  module.directive("taleo", function () {
    return {
      ...
      template:
        '<a href="{{url}}&img={{img}}" type="submit" id="submit_button" target="_blank">Apply Now</a>',
    };
  });
})();
(function () {
  ...
  function StudiosController(
    ...
    $scope.$on("animate.ready", function () {
      ...
      if ($stateParams.lang == "en") {
        $scope.setPagetitle("Paris | France | Studio dada");
        $scope.setPagedescription(
          "We operate from our unique studio in Paris/France."
        );
      } else {
        $scope.setPagetitle("Paris | France | Les ateliers dada");
        $scope.setPagedescription(
          "Nous opérons  depuis notre unique atelier à Paris / France."
        );
      }

      $scope.showVideo =
        typeof EventDetection.getTransitionEvent() !== "undefined";

      $scope.openmap = function (country) {
        if (country == "Paris") {
          window.open(
            "https://www.google.fr/maps/place/Atelier+dada+lumi%C3%A8re+-+Eclairer+intelligemment+pour+vous!/@48.8897973,2.2858155,12z/data=!4m18!1m12!4m11!1m3!2m2!1d2.3565491!2d48.894742!1m6!1m2!1s0x47e66e64f56737cf:0x66658b2b8abedf84!2satelier+dada!2m2!1d2.3558551!2d48.8898185!3m4!1s0x47e66e64f56737cf:0x66658b2b8abedf84!8m2!3d48.8898185!4d2.3558551",
            "blank"
          );
        } else {
          //window.open('https://www.google.com/maps/place/Atelier+dada+_+Lighting+Architects/@23.0230212,72.5597216,15z/data=!4m5!3m4!1s0x0:0x23626d621a310067!8m2!3d23.023047!4d72.557237?hl=en','blank')
          window.open(
            "https://www.google.fr/maps/place/Atelier+dada+lumi%C3%A8re+-+Eclairer+intelligemment+pour+vous!/@48.8897973,2.2858155,12z/data=!4m18!1m12!4m11!1m3!2m2!1d2.3565491!2d48.894742!1m6!1m2!1s0x47e66e64f56737cf:0x66658b2b8abedf84!2satelier+dada!2m2!1d2.3558551!2d48.8898185!3m4!1s0x47e66e64f56737cf:0x66658b2b8abedf84!8m2!3d48.8898185!4d2.3558551",
            "blank"
          );
...
(function () {
  ...
  function StudiosItemController(
    $scope,
    $timeout,
    $stateParams,
    Twitter,
    ...
    $scope.$on("animate.ready", function () {
      ...
      studios
        ...
        .then(function (data) {
          ...
          studios.getTweets($stateParams.location).then(function (data) {
            if (!data.data) {
              return;
            }
          ...
          studios
            .getInstagramPosts($stateParams.location)
            .then(function (data) {
              if (!data.data) {
                return;
              }
...
(function () {
  ...
  module.factory("careerResolverFactory", [
    "$http",
    "$state",
    "careerFactory",
    function ($http, $state, Career) {
      var getAll = function () {
        return $http({
          method: "GET",
          cache: true,
          url: "backend/api/career.json",
        }).then(function (result) {
          return result.data;
        });
      };
...
(function () {
  ...
  module.controller("CareerController", [
    "$scope",
    "$timeout",
    "careerResolverFactory",
    "preloaderService",
    function ($scope, $timeout, career, PreloaderService) {
      $scope.$on("animate.ready", function () {
        $scope.$emit("animate.init");

        $scope.setBreadcrumbs([
          { title: "CAREERS", ref: "pages-career-index", color: "career" },
        ]);
        $scope.setHeaderDisplay(false);
...
(function () {
  ...
  module.controller("CareerItemController", [
    "$scope",
    "$timeout",
    "$location",
    "$stateParams",
    ...
    function (
      ...
      $scope.$on("animate.ready", function () {
        ...
        career
          .getAllByCategory($stateParams.category)
          .then(function (data) {
            $scope.career = data;
      ...
      $stateProvider
        ...
        .state("controls-search.details", {
          ...
          views: {
            ...
            results: {
              templateUrl:
                "assets/frontend/partials/controls/search-results.html",
...
(function () {
  ...
  SearchDirectiveController.$inject = [
    "$scope",
    "$q",
    "$timeout",
    "EventDetection",
  ...
  function SearchDirectiveController(
    ...
    $scope.scrollFilters = Debounce.debounce(
      function ($event) {
        if (!$filters) {
          return;
        }
    ...
    this.selectTerm = function (term, tag, results) {
      ...
      $search.css({
        transform:
          "translateY(" +
          (searchInputOffset.top - searchOffset.top + 25) +
          "px)",
      });
  ...
  module.directive("search", function () {
    return {
      ...
      replace: true,
      template:
        '<div ng-class="{\'search-results-focus\': showResults}" class="full-height-container"><terms></terms><results></results></div>',
  ...
  module.directive("terms", function () {
    return {
      ...
      require: "^search",
      template:
        '<div ui-view name="term" class="animate-in-init animate-in-enter animate-in-enter-complete search-terms accelerate noflicker"></div>',
    };
  });

  module.directive("termsResult", [
    "$timeout",
    "$location",
    "$q",
    function ($timeout, $location, $q) {
      return {
        restrict: "EA",
        replace: true,
        require: "^search",
        ...
        link: function (scope, element, attr, controller) {
          ...
          scope.search = function () {
            ...
            defer.promise.then(function (results) {
              controller
                .selectTerm(scope.result.slug, scope.result.tag, results)
                .then(function () {
                  $timeout(function () {
  ...
  module.directive("termsResultDisplay", function ($stateParams) {
    return {
      restrict: "EA",
      replace: true,
      require: "^search",
      template: [
        '<div id="terms-result-display" ng-show="term.length > 0" ng-class="{\'terms-result-display-active\': active}">' +
          ...
          "<div class=\"search-terms-result-number opacity-animate\" ng-class=\"{'opacity-animate-on': numberOfResults > 0}\"><ng-pluralize ng-if=\"english_lang>0\" count=\"numberOfResults\" when=\"{'0': '0 Results', 'one': '1 Result', 'other': '{} Results'}\"></ng-pluralize><ng-pluralize ng-if=\"french_lang>0\" count=\"numberOfResults\" when=\"{'0': '0 Résultat de recherche', 'one': '1 Résultat de recherche', 'other': '{} Résultats de recherche'}\"></ng-pluralize></div>" +
          "</div>",
      ].join(""),
      link: function (scope, element, attrs, controller) {
        scope.term = "";
  ...
  module.directive("results", [
    ...
    function (Debounce) {
      return {
        ...
        replace: true,
        template:
          '<div ui-view name="results" class="search-results animate-in-init animate-in-enter animate-in-enter-complete search-results"></div>',
      };
    },
  ]);
...
(function () {
  ...
  function Search(Search) {
    ...
    function filter(data, term) {
      var sorted = data.reduce(
        function (prev, current) {
          var currentTags = extractTagsFromString(current["search-expertise"])
...
(function () {
  ...
  function SearchResultsController(
    ...
    function punchItChewy() {
      ...
      $scope.selectedFilters = selectFiltersFromString(
        $scope.filters,
        $scope.selectedFilters
      );
      ...
      var originalResults = searchResolver.filter(data, $scope.search);

      $scope.visibleFilters = getVisibleFilters(originalResults);

      var results = shallowCopyResults(originalResults).filter(
        applyFilters($scope.selectedFilters)
      );
      getResults($scope, results, size, resultsGrid);

      $scope.clearSearch = function () {
        if ($scope.language == "fr") {
          window.location.replace("fr/search");
        } else {
    ...
    function applyFilters(filters) {
      var allTrue = Object.keys(filters).every(function (k) {
...
(function () {
  ...
  function SearchTermsController($scope, $stateParams, $timeout, search) {
...
(function () {
  var module = angular.module("dada.contact", ["ui.router", "dada.studios"]);

  module.config([
    "$stateProvider",
    function ($stateProvider) {
      $stateProvider.state("pages-contact", {
        url: "/:lang/contact",
...
(function () {
  ...
  module.controller("ContactController", [
    ...
    "$http",
    "studiosResolverFactory",
    function ($state, $scope, $stateParams, $http, studios) {
      $scope.$on("animate.ready", function () {
        //.

        $scope.$emit("animate.init");

        //  var url  = "https://www.atelierdada.com/atelier/content/0.1/get-page?slug=about-nirmit&lang=fr";

        /*
       $http.get("http://www.appdemo.co.in/atelier/content/0.1/get-page?slug=contact-us&lang="+$stateParams.lang).then( function(response)
        {
...
*/
        ...
        $scope.setBreadcrumbs([
          { title: "CONTACT", ref: "pages-contact", color: "contact" },
        ]);
        $scope.setHeaderDisplay(false);
        $scope.language = $stateParams.lang;
        ...
        if ($stateParams.lang == "en") {
          $scope.setPagedescription(
            "We operate from our unique studio in Paris/France. Give us a call, send us an email or drop by to have a chat. "
          );
          $scope.setPagetitle(
            "Contact us for new ideas and initiatives in lighting design"
          );
        } else {
          $scope.setPagedescription(
            "Nous opérons à partir de notre unique atelier à Paris / France. Appelez-nous, envoyez-nous un courriel ou passez nous voir pour discuter."
          );
          $scope.setPagetitle(
            " Contactez-nous pour des idées et initiatives novatrices en conception lumière"
          );
        }
        ...
        $scope.select = function (title) {
          if (title == "Paris") {
            $scope.isparisSelected = true;
            $scope.isahmedabadSelected = false;
            $scope.ishydrabadSelected = false;
          } else if (title == "Hydrabad") {
            $scope.isparisSelected = true;
            $scope.isahmedabadSelected = false;
            $scope.ishydrabadSelected = false;
          } else {
        ...
        $scope.gotostudio = function () {
          $state.go("pages-studios-index", { lang: $stateParams.lang });
          //   $state.go('pages-news-show', { article: this['title-slug'] ,lang:$stateParams.lang});
          // { article: this['title-slug'] ,lang:$stateParams.lang}
        };
        ...
        studios.getAll().then(function (data) {
          ...
          for (var i = 0; i < studioData.length; i++) {
            formatted.push({
              key: studioData[i].email,
              value: studioData[i].title,
            });
          }

          var validatefields = {
            contact1: ["firstname", "email", "phone", "message"],
            contact2: ["subject", "message"],
            contact3: [],
          };
          ...
          $scope.validate = function () {
            ...
            for (i = 0; i < validate.length; i++) {
              var validateForm = validatefields[validate[i]];

              for (var j = 0; j < validateForm.length; j++) {
                if ($scope.contactForm[validateForm[j]].$invalid === true) {
                  valid = false;
                  break;
                }
              }
          ...
          $scope.show = function (id) {
            var show = function () {
              for (var i in $scope.stages) {
                if ($scope.stages.hasOwnProperty(i)) {
                  $scope.stages[i] = i === id;
                }
              }
            };
            ...
            if ($scope.validate()) {
              if (id === "contact3") {
                ...
                $http
                  .post("backend/sendemail.php", $scope.contact)
    ...
    function ($stateProvider) {
      $stateProvider
        .state("pages-info-privacy", {
          url: "/:lang/privacy-policies",
          templateUrl:
            "assets/frontend/partials/pages/info/privacy-policies.html",
        ...
        .state("pages-info-terms", {
          ...
          templateUrl:
            "assets/frontend/partials/pages/info/terms-and-conditions.html",
...
(function () {
  ...
  module.factory("termsResolverFactory", [
    "$http",
    "$state",
    function ($http, $state) {
      var getAll = function () {
        return $http({
          method: "GET",
          url: "backend/api/terms-and-conditions.json",
        }).then(function (result) {
          if (result.data) {
            return result.data;
          }
...
(function () {
  ...
  module.factory("privacyResolverFactory", [
    "$http",
    "$state",
    function ($http, $state) {
      var getAll = function () {
        return $http({
          method: "GET",
          url: "backend/api/privacy-policies.json",
        }).then(function (result) {
          if (result.data) {
            return result.data;
          }
    ...
    $scope.$on("animate.ready", function () {
      privacy
        ...
        .then(function (data) {
          ...
          if ($stateParams.lang == "en") {
            $scope.setBreadcrumbs([
              { title: "Legal Notice", ref: "pages-info-privacy", color: "" },
            ]);
            $scope.setPagetitle("Legal Notice");
          } else {
            $scope.setBreadcrumbs([
              {
                title: "Mentions légales",
                ref: "pages-info-privacy",
                color: "",
              },
            ]);
            $scope.setPagetitle("Mentions légales");
          }
        ...
        .then(function () {
          console.log("animattion finished");
          $scope.$emit("animate.enter", true);
        });
    });
  }
...
(function (window) {
  ...
  var directive = window.angular.module(
  ...
  directive("paneHeader", function () {
    return {
      ...
      replace: true,
      template:
        '<div ng-transclude class="angular-accordion-header" ng-click="toggle()" ng-class="{ angularaccordionheaderselected: expanded, angulardisabledpane: disabled }"></div>',
  ...
  directive("paneContent", function () {
    return {
      ...
      replace: true,
      template:
        '<div ng-transclude class="angular-accordion-pane-content" ng-show="expanded"></div>',
    };
  });
})(window);
(function (window) {
  ...
  directive("animateIn", [
    ...
    "$animate",
    "EventDetection",
    function ($q, $timeout, $animate, EventDetection) {
      // elements
        ...
        controller: [
          ...
          function ($scope, $rootScope, $element) {
            ...
            $timeout(function () {
              ...
              if (previousElement) {
                previousElement[0].addEventListener(
                  EventDetection.getAnimationEvent(),
                  function (event) {
                    if (
                      typeof $(event.target).attr("animate-in") !== "undefined"
                    ) {
              ...
              $scope.$on(
                "animate.enter",
                function (event, disablePager, immediate) {
                  $timeout(function () {
                    eventReceived = true;
                    pagerDisabled = disablePager === true;
                    forceImmediate =
                      immediate === true ||
                      typeof EventDetection.getTransitionEvent() ===
                        "undefined";
                    enter();
                  }, 200);
                }
              ...
              $scope.$on("animate.hide", function (event, callback) {
                ...
                currentElement.on(
                  EventDetection.getTransitionEvent(),
                  function (event) {
                    var $target = $(event.target);

                    var transform =
                      event.originalEvent.propertyName &&
                      event.originalEvent.propertyName.match(
                        /^(.+)?(transform)$/
                      ) !== null;
                    if (
                      typeof $target.attr("animate-in") !== "undefined" &&
                      transform
                    ) {
                      callback();
    ...
    function ($timeout, Debounce) {
      ...
      function animateComplete() {
        ...
        $timeout(function () {
          currentWidth =
            originalWidth +
            $crumbs.children(".oh-by-golly-crumbs-width").width();
          if (window.innerWidth > 1024) {
            currentWidth -= 16;
          }
...
(function (window) {
  ...
  directive("owlCarousel", [
    ...
    "Debounce",
    "EventDetection",
    function ($timeout, $document, $location, Debounce, EventDetection) {
      var pager = function ($el, scope) {
        ...
        var debounceMouseWheelInput = Debounce.debounce(
          function (params) {
            var emitEvents =
              typeof scope.emitEvents === "string" ? scope.emitEvents : "true";
      ...
      return {
        ...
        link: function (scope, element) {
          ...
          if (
            scope.trackIndex === true &&
            typeof EventDetection.getTransitionEvent() !== "undefined"
          ) {
            scope.index =
              typeof index === "undefined"
                ? 0
                : Number($location.search().index);
          ...
          var init = function () {
            if (
              scope.showControlsThreshold &&
              $el.children().length <= scope.showControlsThreshold
            ) {
              options.nav = false;
            }
...
(function (window) {
  ...
  directive("cacheRefresh", [
    "$state",
    "$window",
    "$http",
    function ($state, $window, $http) {
      function reload() {
      ...
      return {
        ...
        link: function (scope, element) {
          element.on("click", function () {
            ...
            if (sources.length) {
              $http
                .get("/backend/api/clear_cache?keys=" + sources.join("|"))
                .then(reload);
            } else {
...
(function (window) {
  ...
  function ZoomControl(controlDiv, map) {
    ...
    zoomInButton.style.backgroundImage =
      "url(assets/frontend/images/map_plus.svg)";
    ...
    zoomOutButton.style.backgroundImage =
      "url(assets/frontend/images/map_minus.svg)";
  ...
  function splitAddress(address) {
    ...
    if (address && typeof address == "string" && address.length) {
      line1 = address.split(",").map(function (line) {
        return line.trim();
      });
        ...
        link: function (scope, element) {
          ...
          function loadGoogleMaps() {
            ...
            script_tag.setAttribute(
              "src",
              "http://maps.google.com/maps/api/js?key=AIzaSyDqBFnwVB_vAFuk3J_cxX6P7K_-KlB8vaw&callback=gMapsCallback"
            );
...
(function (window) {
  ...
  var nonDomainRegex =
    /(http|https):\/\/(dada\.app|stage\.dada\.com|www\.dada\.com)/;
  var relativeUrlRegex =
    /^(\/)?(work|think|news|careers|about|studios|publications)/;

  directive("contentLinksNewTab", [
    "$timeout",
    function ($timeout) {
      return {
        restrict: "A",
...
(function () {
      ...
      controller: [
        ...
        function ($scope, $state, $stateParams) {
          ...
          $scope.hideText = function () {
            for (var i in $scope.cities) {
              if (
                $scope.cities.hasOwnProperty(i) &&
                $scope.cities[i].selected === true
              ) {
                return true;
              }
            }
  ...
  directive("mobMap", function () {
    return {
      ...
      replace: true,
      template:
        "<a ui-sref=\"/studios/{{studio['location-slug']}}\">{{studio.title}}</a>",
    };
  });
...
(function (window) {
  ...
  function PagerController(
    ...
    var debouncedMouseWheelInput = Debounce.debounce(
      debounceMouseWheelInput,
      150,
      true
    );
    ...
    this.addPage = function (page) {
      ...
      if (page.scope.index === initPage) {
        ...
        if (typeof page.scope.data !== "undefined") {
          ...
          if (typeof page.scope.data.image === "string") {
            ...
            image =
              typeof page.scope.data.background === "string"
                ? page.scope.data.background
                : page.scope.data.background.src;
          }
      ...
      if (transitionsSupported) {
        page.element.on(transitionEvent, function (event) {
          ...
          //    console.log("direction down"+DIRECTION_DOWN);
          ...
          checkPage =
            $scope.direction === DIRECTION_DOWN ? $scope.page : $scope.page + 1;
          ...
          console.log("pages " + $scope.pages[checkPage].element[0]);

          if (event.target === $scope.pages[checkPage].element[0]) {
            var delay = eventRebindDelay;
            if (
              $scope.current().scope.loaded === false &&
              $scope.current().scope.data &&
              $scope.current().scope.data.type === "grid"
            ) {
              delay = 0;
            }
  ...
  directive("pager", function () {
    return {
      ...
      transclude: true,
      template:
        '<div><div ng-transclude ng-class="{\'page-peak\': peak, \'pager-show-footer\': showFooter, \'pager-footer-focus\': footerHasFocus, \'pager-footer-focus-complete\': footerFocusComplete}" msd-wheel="mouseWheel($event, $delta, $deltaX, $deltaY)"></div><div class="pager-chevron-container" ng-click="mouseWheel($event, null, null, 0)"><div class="pager-chevron"></div></div></div>',
  ...
  directive("page", [
    function () {
      return {
        ...
        transclude: true,
        template:
          "<div ng-transclude class=\"page\" ng-class=\"{'ng-show': $parent.page >= index, 'page-next': ($parent.page + 1) === index, 'page-selected': selected, 'page-initialized': initialized}\"></div>",
        scope: {
          index: "=",
          locked: "=",
          data: "=",
    ...
    return {
      ...
      link: function (scope, element) {
        scope.getTemplateUrl = function () {
          ...
          var template = scope.item.template || "crop-1-column-text";

          if (typeof scope.$parent.think !== "undefined") {
            element
              .next()
              .find("h2")
              .css("color", scope.$parent.$parent.$parent.colors.think);
          } else if (typeof scope.$parent.work !== "undefined") {
            element
              .next()
              .find("h2")
              .css("color", scope.$parent.$parent.$parent.colors.work);
          }
...
(function (window) {
  ...
  var service = window.angular.module(
      ...
      Preloader.prototype.preloadAll = function () {
        for (var i = 0; i < arguments.length; i++) {
          ...
          for (var j = 0; j < data.length; j++) {
            if (
              data[j].background === null ||
              typeof data[j].background === "undefined"
            ) {
              continue;
            }

            if (
              typeof data[j].background === "object" &&
              typeof data[j].background.src === "string"
            ) {
...
(function () {
  ...
  var nativeModules = ["ngAnimate", "ngSanitize", "ngTouch"];
...
(function (window) {
  ...
  window.app.run([
    ...
    "$stateParams",
    "$location",
    function ($rootScope, $state, $urlRouter, $stateParams, $location) {
      $rootScope.$on("$stateChangeSuccess", function (event, toState) {
        $rootScope.pagerContent = toState.name.match(
          /^news|pages-home|pages-work-index|pages-studios-index/
        )
          ? true
          : false;
        $rootScope.pagerContentMobile = toState.name.match(/^controls-search/)
          ? true
          : false;

        $rootScope.showLoader = toState.name.match(/^controls-navigation/)
          ? false
          : true;
        $rootScope.controlsActive = toState.name.match(/^controls/)
          ? true
          : false;
        ...
        $rootScope.$on("$locationChangeSuccess", function () {
          ...
          if (part_url[1] == "fr") {
            $rootScope.eng_url = url.replace("/fr", "/en");
            $rootScope.eng_url = $rootScope.eng_url.replace(
              "/category/urbain",
              "/category/urban"
            );
            $rootScope.eng_url = $rootScope.eng_url.replace(
              "/category/r%C3%A9sidentiel",
            ...
            $rootScope.eng_url = $rootScope.eng_url.replace(
              "/category/h%C3%B4telier",
              "/category/hospitality"
            );
            $rootScope.eng_url = $rootScope.eng_url.replace(
              "/category/ev%C3%A8nementiel",
              "/category/event"
            );
            $rootScope.eng_url = $rootScope.eng_url.replace(
              "/category/produit",
            ...
            $rootScope.french_url = url.replace("/en", "/fr");
            $rootScope.french_url = $rootScope.french_url.replace(
              "/category/urban",
              "/category/urbain"
            );
            $rootScope.french_url = $rootScope.french_url.replace(
            ...
            $rootScope.french_url = $rootScope.french_url;
        ...
        if (part_url[1] == "fr") {
          ...
          //   $rootScope.eng_url  =   $rootScope.eng_url.replace('/category/commercial', '/category/commercial');
          $rootScope.eng_url = $rootScope.eng_url.replace(
            "/category/institutionnel",
            "/category/institution"
          );
          ...
          // $rootScope.eng_url =  $rootScope.eng_url + qs ;
          //   console.log(  $rootScope.eng_url + qs  );
