  ...
  function WorkItemController($http,$scope, $state,$timeout, $stateParams, work, PreloaderService) {
    $scope.$on('animate.ready', function () {
      ...
      work.get($stateParams.id)
        ...
        if($stateParams.id=="the-mango-tree-house-facade" || $stateParams.id=="the-mango-tree-house-interior" || $stateParams.id=="the-mango-tree-house-landscape" || $stateParams.id=="villa-des-manguiers-landscape" || $stateParams.id=="villa-manguiers-intérieurs" || $stateParams.id=="villa-manguiers-facade" )
        {
          ...
          $scope.testimonial_dada_speech = "";
           ...
           $scope.testimonial_client2 = "Mr. Ujjval Panchal";
        ...
        //dalal-villas and  dalal-villas-product
         if($stateParams.id=="dalal-villas" || $stateParams.id=="dalal-villas-product" || $stateParams.id=="dalal-villas-paysage" || $stateParams.id=="dalal-villas-produit"   )
        {
         ...
         if($stateParams.id=="unesco-the-big-hall" || $stateParams.id=="unesco-grande-salle" )
        {
        ...
        if($stateParams.id=="sumel-6" ||  $stateParams.id=="mondeal-square-facade"  || $stateParams.id=="mondeal-square-landscape" || $stateParams.id=="sumel-3" || $stateParams.id=="mondeal-heights" || $stateParams.id=="complexe-commercial-sumel-6" || $stateParams.id=="complexe-commercial-sumel-3"   || $stateParams.id=="complexe-commercial-sumel-3" || $stateParams.id=="tours-jumelles-mondeal-square-facade" || $stateParams.id=="tours-affaires-mondeal-heights" || $stateParams.id=="mondeal-square-paysage"  )
        {
          ...
          $scope.testimonial_dada_speech = "";
           ...
           if($stateParams.id=="shivalik-hs" || $stateParams.id=="tour-shivalik-high-street" )
        {
          ...
          if($stateParams.id=="ccbta-terre-d-argence"  || $stateParams.id=="ppp-goussainville")   //put in goussainvile also
        {
          $scope.testimonial_client = "Jean Sabatier";
          $scope.testimonial_studio = "Lumières Urbaines, Ancien Président de l’ACE";
          $scope.testimonial_client_speech = "Naissance d'une star! <br/>J'ai mis à l'épreuve sa sensibilité, son sens artistique et sa perception du besoin des habitants en terme d'identification des espaces, de sécurité et d'amélioration du cadre de vie. Mme Bouhlel a exprimé avec une remarquable justesse les lignes fortes d'un programme d'aménagement lumière, parfaitement reconnu par les élus et admis par les services techniques.Après un travail d'analyse d'une grande précision, elle a montré avec clarté les tendances, les équilibres, les variations propres à valoriser sans excès un milieu urbain de nature aussi différenciée, à la grande satisfaction de tous les acteurs.";
          $scope.testimonial_dada_speech = "";
        }
